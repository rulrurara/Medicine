...
function reloadList(){
	...
	function drawList(list){
		...
		for(var data of list){
			...
			html += "<th>";
			html += "<input type=\"checkbox\"class=\"check\" id=\"check\" name=\"checkdel\" value=\"" + data.FAQ_NUM + "\">";
			html += "</th>";
			html += "<td no = \"" + data.FAQ_NUM + "\">"+ data.GBN_NM +"</td>";
			html += "<td no = \"" + data.FAQ_NUM + "\">"+ data.TITLE + "</td>";
			html += "</tr>";
	}
		$("tbody").html(html);
