...
function reloadList(){
	...
	function drawList(list){
		...
		for(var data of list){
			html += "<tr no = \"" + data.TXT_NUM + "\">";
			html += "<th>";
			html += "<input type=\"checkbox\"class=\"check\" id=\"check\" name=\"checkdel\" value=\"" + data.TXT_NUM + "\">";
			html += "</th>";
			html += "<td no = \"" + data.TXT_NUM + "\">"+ data.TXT_NUM +"</td>";
			html += "<td no = \"" + data.TXT_NUM + "\">" + data.NM + "</div></td>";
			html += "<td no = \"" + data.TXT_NUM + "\">" + data.TITLE + "</td>";
			html += "<td no = \"" + data.TXT_NUM + "\">"+ data.REG_D + "</td>";
			html += "<td no = \"" + data.TXT_NUM + "\">"+ data.HIT + "</td>";
			html += "</tr>";
	}
		$("tbody").html(html);
