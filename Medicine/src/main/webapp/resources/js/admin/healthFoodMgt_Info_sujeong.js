...
$(document).ready(function() {
	reloadList();
	$("#com").val($("#comNum").val());
	$("#shape").val($("#shapeNum").val());
	
	$("#num").val($("#funcnmNo").val());
	$("#num1").val($("#nutnmNo").val());
	$("#fig").val($("#fignmNo").val());
...
$("#funcinyes").on("click", function(){
		            ...
		            success : function(res){ // 데이터 주고 받기 성공 시
		               ...
		               $.ajax({
				        	 ...
				        	 success : function(res){
								...
								case "success":
									alert("수정완료");
									$("#funcnm").val($("#funcnm").val()+ " " +$("#funcnm").val());
			                        $("#nutnm").val($("#nutnm").val()+ " " +$("#nutnm").val());
			                        $("#fig").val($("#fig").val()+ " " +$("#fig").val());
			                        
									if($("#funcnmNo").val() == "") {
										$("#funcnmNo").val(res.hfmid);
									} else {
										$("#funcnmNo").val($("#funcnmNo").val()+ "," +res.hfmid);
									}
									
									if($("#nutnmNo").val() == "") {
										$("#nutnmNo").val(res.hfmid);
									} else {
										$("#nutnmNo").val($("#nutnmNo").val()+ "," +res.hfmid);
									}
									
									if($("#fignmNo").val() == "") {
										$("#fignmNo").val(res.hfmid);
									} else {
										$("#fignmNo").val($("#fignmNo").val()+ "," +res.hfmid);
									}
	...
	function insertTr2(){
	 ...
	 var insertTr = "";
	   insertTr += "<tr>";
	   insertTr += "<td><input type=\"text\" class=\"text\" name=\"com\" id=\"comIn\" placeholder=\"내용을 입력하세요.\" /></td>";
	   insertTr += "</tr>";
