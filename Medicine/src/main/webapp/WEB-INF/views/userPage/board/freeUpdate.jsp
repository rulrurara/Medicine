...
<form action="#" id="actionForm">
	<input type="hidden" name="num" value="${data.TXT_NUM}">
	...
	<div class="titlewrap">
		<input type="text" class="titletext" value="${data.TITLE }" name="title">
	</div>
	<input type="text" id="con" name="con" value="${data.CON}">
	<div class="btnwrap">
		<input type="button" class="registerbtn" value="수정">
